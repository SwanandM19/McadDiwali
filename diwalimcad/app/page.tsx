...
// // import { Search, Star, Award, Users, BookOpen, Clock, CheckCircle, TrendingUp, ChevronDown, ChevronUp, Menu, X, Phone, MapPin, IndianRupee, Calendar } from 'lucide-react';
...
// //   const batchPreference = (form.elements.namedItem('batch_preference') as HTMLSelectElement).value;
...
// //       alert('✓ Form details saved successfully! Now proceed with payment.');
// //     } else {
...
// //   if (!formSubmitted || !formData || !selectedOfflineCourse) {
// //     alert('Please submit the form details first!');
// //     return;
// //   }

// //   try {
// //     const feeAmount = selectedOfflineCourse.feeNumeric;
// //     const orderId = await createOrderId(feeAmount, 'INR', selectedOfflineCourse.title);

// //     const options = {
// //       key: process.env.NEXT_PUBLIC_RAZORPAY_KEY_ID,
// //       amount: feeAmount * 100,
// //       currency: 'INR',
// //       name: 'M CAD Solutions',
// //       description: selectedOfflineCourse.title,
// //       image: 'https://mcadsolution.com/logo.png',
// //       order_id: orderId,
...
// //             await axios.post('/api/enrollment/update-payment', {
...
// //       },
// //       notes: {
// //         course: selectedOfflineCourse.title,
...
// //   const handleEnrollmentSubmit = async (e: React.FormEvent<HTMLFormElement>): Promise<void> => {
// //     e.preventDefault();
// //     if (!selectedOfflineCourse) return;
...
// //           course: selectedOfflineCourse.title,
// //           address: 'Karve Nagar, Pune',
// //           batch_preference: (form.elements.namedItem('batch_preference') as HTMLSelectElement).value
// //         },
// //         theme: {
// //           color: '#ea580c'
// //         },
...
// //                     <div>
// //                       <h2 className="text-3xl font-bold text-orange-600">{course.title}</h2>
...
// //                   <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6 bg-orange-50 p-4 rounded-lg">
...
// //                       <p className="font-semibold text-orange-600">{course.fee}</p>
// //                     </div>
// //                   </div>

// //                   <div className="space-y-6">
// //                     <div>
// //                       <h3 className="text-xl font-bold mb-3">Course Overview</h3>
// //                       <p className="text-gray-700 leading-relaxed">{course.detailedInfo.overview}</p>
// //                     </div>
...
// //                       <p className="text-gray-700 leading-relaxed">{course.detailedInfo.certification}</p>
// //                     </div>

// //                     <div>
// //                       <h3 className="text-xl font-bold mb-3">Placement Support</h3>
// //                       <p className="text-gray-700 leading-relaxed">{course.detailedInfo.placement}</p>
// //                     </div>

// //                     <div>
// //                       <h3 className="text-xl font-bold mb-3">Prerequisites</h3>
// //                       <p className="text-gray-700 leading-relaxed">{course.detailedInfo.prerequisites}</p>
// //                     </div>
...
// //                           <div key={idx} className="flex items-center gap-2 bg-blue-50 p-3 rounded">
...
// //                       }}
// //                       className="flex-1 bg-orange-600 text-white py-3 rounded-md hover:bg-orange-700 transition font-semibold"
// //                     >
// //                       Enroll Now
// //                     </button>
// //                     <button
// //                       onClick={handleWhatsApp}
// //                       className="flex-1 border-2 border-green-500 text-green-600 py-3 rounded-md hover:bg-green-50 transition font-semibold"
// //                     >
// //                       Talk to Counselor
// //                     </button>
// //                   </div>
...
// //       {/* Enrollment Form Modal with Razorpay */}
// // {showEnrollmentForm && selectedOfflineCourse && (
// //   <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4 overflow-y-auto">
// //     <div className="bg-white rounded-lg p-8 max-w-2xl w-full my-8">
// //       <div className="flex justify-between items-start mb-4">
// //         <div>
// //           <h2 className="text-2xl font-bold">{selectedOfflineCourse.title}</h2>
// //           <p className="text-gray-600 text-sm mt-1">Fill the form to complete enrollment</p>
// //         </div>
// //         <button 
// //           onClick={() => { 
// //             setShowEnrollmentForm(false); 
...
// //           <div>
// //             <p className="text-sm text-gray-600">Course Fee</p>
// //             <p className="text-2xl font-bold text-orange-600">{selectedOfflineCourse.fee}</p>
// //           </div>
// //           <div className="text-right">
// //             <p className="text-sm text-gray-600">Duration</p>
// //             <p className="font-semibold">{selectedOfflineCourse.duration}</p>
// //           </div>
// //         </div>
// //       </div>
...
// //           <p className="text-green-800 font-semibold">✓ Form details saved successfully!</p>
// //           <p className="text-sm text-green-600">Now proceed with payment</p>
// //         </div>
// //       )}
...
// //           className="w-full mb-4 px-4 py-2 border rounded h-20"
// //           disabled={formSubmitted}
// //         ></textarea>

// //         <div className="mb-4 p-4 bg-blue-50 rounded">
// //           <h4 className="font-semibold mb-2 text-sm">Payment Options:</h4>
// //           <div className="text-xs text-gray-700 space-y-1">
// //             <p>✓ Full Payment via Razorpay (Card/UPI/NetBanking)</p>
// //             <p>✓ Installment Option: 50% now, 50% before 7th session</p>
...
// //                 type="button" 
// //                 onClick={handleWhatsApp} 
// //                 className="flex-1 border-2 border-green-500 text-green-600 py-3 rounded hover:bg-green-50 font-semibold"
// //               >
// //                 Talk to Counselor
// //               </button>
// //             </>
...
// //                 className="flex-1 bg-orange-600 text-white py-3 rounded hover:bg-orange-700 font-semibold flex items-center justify-center gap-2"
// //               >
// //                 <CheckCircle className="w-5 h-5" />
// //                 Proceed to Payment
// //               </button>
...
// //           <h2 className="text-3xl font-bold mb-3">Industry-Focused Courses</h2>
// //           <p className="text-gray-600 mb-6">Job-oriented programs designed to build strong careers in Automotive Design & CAD</p>

// //           {/* Course Mode Toggle */}
// //           <div className="inline-flex rounded-lg border border-gray-300 bg-white p-1 shadow-sm mb-8">
// //             <button
// //               onClick={() => setShowCourseMode('online')}
// //               className={`px-8 py-2 rounded-md font-semibold transition ${showCourseMode === 'online'
...
// //               className={`px-8 py-2 rounded-md font-semibold transition ${showCourseMode === 'offline'
// //                 ? 'bg-orange-600 text-white'
// //                 : 'text-gray-700 hover:text-orange-600'
// //                 }`}
// //             >
...
// //             {/* Online Courses Grid WITH IMAGES */}
...
// //             {/* Combo Courses WITH IMAGES */}
// //             <h3 className="text-2xl font-bold mb-6">Combo Packages</h3>
// //             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
// //               {comboCourses.map((combo, idx) => (
// //                 <div
// //                   key={idx}
// //                   className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow border-2 border-orange-200 cursor-pointer"
...
// //         ) : (
// //           <>
// //             {/* Offline Courses Info Banner */}
// //             <div className="bg-gradient-to-r from-orange-100 to-blue-100 p-6 rounded-lg mb-8 text-center">
...
// //             {/* Offline Courses Grid WITH IMAGES */}
...
// //                   </div> */}
// //                   <div className="p-5">
// //                     <div className="bg-orange-100 text-orange-800 text-xs font-semibold px-2 py-1 rounded inline-block mb-2">
// //                       {course.discount}
// //                     </div>
// //                     <h3 className="font-bold text-lg mb-2">{course.title}</h3>
...
// //                         className="w-full border-2 border-orange-600 text-orange-600 py-2 rounded-md hover:bg-orange-50 transition font-semibold"
// //                       >
// //                         View Details
// //                       </button>
// //                       <button
...
// //               <h3 className="text-2xl font-bold mb-6 text-center">Why Choose Classroom Training?</h3>
...
// //       {/* Continue with all other sections exactly as they were in your original code... */}
// //       {/* Why Choose Section, Training Domains, Testimonials, CTA, FAQ, Footer - KEEP THEM EXACTLY THE SAME */}
...
// //                   <div className="w-16 h-16 rounded-full mr-4 flex items-center justify-center overflow-hidden flex-shrink-0">
// //                     <img
...
// //             <button
// //               onClick={() => window.open('https://www.youtube.com/playlist?list=PL0m-ZlKLtTL5C8_hlQ3PoIPoSNKqin8py', '_blank')}
// //               className="bg-orange-600 text-white px-8 py-3 rounded-md hover:bg-orange-700 transition font-semibold"
// //             >
    ...
    <div className="bg-white dark:bg-gray-800 py-6 md:py-8 shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 text-center">
          ...
          <div>
            <div className="text-2xl md:text-3xl font-bold text-orange-600 dark:text-orange-400">200+</div>
            <div className="text-gray-600 dark:text-gray-300 text-xs md:text-sm">Students Placed</div>
          </div>
          <div>
            <div className="text-2xl md:text-3xl font-bold text-orange-600 dark:text-orange-400">13+</div>
